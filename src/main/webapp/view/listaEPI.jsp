...
<div class="search-container">
    <s:form action="buscarEPI" theme="simple" method="get">
        <s:textfield name="nomeBusca" placeholder="Buscar por nome" cssClass="search-input"/>
        <s:submit value="Buscar" cssClass="search-btn"/>
    </s:form>
</div>
